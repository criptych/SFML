...
////////////////////////////////////////////////////////////
void Shader::setParameter(const std::string& name, const TransformBase& transform)
{
    if (m_shaderProgram)
    {
        ensureGlContext();
...
{
    // Check the cache
    ParamTable::const_iterator it = m_attribs.find(name);
    if (it != m_attribs.end())
    {
...
bool Shader::compile(const char* vertexShaderCode, const char* fragmentShaderCode)
{
    ...
    ParamTable::const_iterator it = m_attribs.begin();
